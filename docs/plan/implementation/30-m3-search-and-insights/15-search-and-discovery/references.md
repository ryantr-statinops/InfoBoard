...
| Type | Reference | Use |
| --- | --- | --- |
| Product | [Product requirements](../../../../product/internal-prd/02-product-requirements.md), `PR-RET-02…05` | Retrieval user value |
| Architecture | [Search and analytics](../../../../architecture/05-search-and-analytics.md), [indexing](../../../../architecture/04-indexing-pipeline.md) | FTS, semantic, RRF, and hydration |
