...
| IP-03 | [Phase 03](phase-03-extension-scaffold-and-command.md) | Integrated in dev | Codex | dev (from implementation/ip-03-extension-scaffold-and-command) | — | 52eac265472f4592b39ad65ad861084df3ecba19 | Toolbar popup; open Ctrl+Shift+Y / Command+Shift+Y and close Ctrl+Shift+X / Command+Shift+X; no page injection. On dev: build, 7 extension unit checks, 9 domain tests, targeted Go tests, corpus, six fixtures, and diff check PASS. Chrome/Edge popup journey skipped as authorized. | Acceptance remains unverified: prior Chrome run timed out waiting for service worker; Edge binary unavailable. User directed merge before this gate; PR not opened. | 2026-09-24 |
