...
| IP-03 | [Phase 03](phase-03-extension-scaffold-and-command.md) | Blocked | Codex | implementation/ip-03-extension-scaffold-and-command | — | d54d793791283d5b75653d9f53b54702c84dff47 | Build/corpus/domain checks PASS; 5 extension unit/manifest checks PASS. Final Chrome command: 1 failed/5 passed (45s waiting for service worker); Edge binary missing, and install requires unavailable sudo. | Browser admin: permit unpacked extensions in Chrome; provide/install Edge, then rerun both parity commands. Not integrated or pushed; no release PR. | 2026-09-24 |
