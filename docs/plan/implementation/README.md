...
|---|---|---|---|---|---|---|---|---|---|
| IP-01 | [Phase 01](phase-01-contract-and-fixtures.md) | Complete | Codex | implementation/ip-01-contract-and-fixtures | — | 2da83f6 | On dev: catalog/schema validation passed; 25 requirement owners, 9 fixtures, 19 seams; 3 negative probes rejected; links and git diff --check passed | `fixtures/catalog.json`, `fixtures/catalog.schema.json` | 2026-09-23 |
