...
| IP-02 | [Phase 02](phase-02-domain-identifiers-and-ownership.md) | Complete | Codex | dev | — | 5f4f0f20f2c73b23487d097fc67bedb6cab5e983 | Corpus and six fixture cases PASS; TypeScript build/domain tests (9 pass), Go projection/activation/shared-fixture tests PASS on dev | IP-02 contract integrated; IP-03 consumes profile identity and atomic projection contracts | 2026-09-24 |
| IP-03 | [Phase 03](phase-03-extension-scaffold-and-command.md) | Blocked | Codex | implementation/ip-03-extension-scaffold-and-command | — | 85d0f8cfb735378dd59ab1f5a5178ac398531d1e | Toolbar popup; open Ctrl+Shift+Y / Command+Shift+Y and close Ctrl+Shift+X / Command+Shift+X; no page injection. Build, 7 extension unit checks, 9 domain tests, targeted Go tests, corpus, six fixtures, and diff check PASS. Chrome popup journey: 1 failed/7 passed; service-worker event timed out in disposable profile. | Browser owner: allow unpacked extension startup in Playwright profile and provide/install Edge; rerun Chrome/Edge acceptance. Not integrated/pushed; no PR. | 2026-09-24 |
