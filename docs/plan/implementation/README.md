...
| IP-03 | [Phase 03](phase-03-extension-scaffold-and-command.md) | Blocked | Codex | implementation/ip-03-extension-scaffold-and-command | — | 38c731ead8ef9d555d871fa032429cb85897ad5f | Build/corpus/domain checks PASS; 5 extension unit/manifest checks PASS. Chrome browser journey: 1 failed/5 passed (45s timeout waiting for extension worker); Edge journey: binary missing; install requires unavailable sudo. | Browser admin: permit unpacked extensions in Chrome; provide/install Edge, then rerun both parity commands. Not integrated or pushed; no release PR. | 2026-09-24 |
