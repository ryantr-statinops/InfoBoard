...
| IP-03 | [Phase 03](phase-03-extension-scaffold-and-command.md) | Blocked | Codex | implementation/ip-03-extension-scaffold-and-command | — | 34131216cd2ace8d9ec396a220fa49887a8a3e3a | Updated preview implemented as toolbar action popup without page injection. Build/corpus/domain and 6 extension unit checks PASS; full Chrome run: 1 failed/6 passed, worker event timeout in disposable profile. Edge binary missing; install needs sudo. | Browser owner: allow unpacked extension startup in Playwright profile and provide/install Edge; then rerun Chrome/Edge acceptance. Not integrated/pushed; no PR. | 2026-09-24 |
