...
| Architecture | [Lifecycle/recovery](../../../../architecture/06-lifecycle-and-recovery.md), [security](../../../../architecture/07-security-boundaries.md) | Health and redaction boundaries |
