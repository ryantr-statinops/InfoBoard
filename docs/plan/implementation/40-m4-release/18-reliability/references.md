...
| Architecture | [Lifecycle and recovery](../../../../architecture/06-lifecycle-and-recovery.md), [data model](../../../../architecture/02-data-model-and-erd.md), [interfaces](../../../../architecture/09-interface-contracts.md) | Canonical/derived, cleanup, and recovery boundaries |
