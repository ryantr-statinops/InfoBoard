...
| Architecture | [Security boundaries](../../../../architecture/07-security-boundaries.md), [ingestion](../../../../architecture/03-ingestion-pipeline.md), [interfaces](../../../../architecture/09-interface-contracts.md) | Input, network, error, and rendering controls |
