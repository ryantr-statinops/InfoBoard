...
| Architecture | [System overview](../../../../architecture/00-system-overview.md), [tech stack](../../../../architecture/01-tech-stack.md), [interfaces](../../../../architecture/09-interface-contracts.md) | Process, runtime, settings, and health boundaries |
