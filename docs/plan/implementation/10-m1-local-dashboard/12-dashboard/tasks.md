...
- [ ] <a id="t12-002"></a>**T12-002 — Add capture, detail, edit, and soft delete flows**
  - Product: `PR-CAP-01`, `PR-UX-01` · Evidence: `RQ-001`
...
- [ ] <a id="t12-003"></a>**T12-003 — Add collection assignment and filters**
  - Product: `PR-ORG-01…02` · Evidence: `RQ-002`
...
- [ ] <a id="t12-005"></a>**T12-005 — Verify responsive and degraded dashboard states**
  - Product: `PR-UX-01`, `PR-RET-06` · Evidence: `RQ-010`
  - Depends on: `T12-003`, `T12-004` · Code: UI states and analytics messaging
  - Verify: browser smoke at 1440 px and 390 px plus component-unavailable scenario
  - Accept when: core dashboard remains understandable and does not claim unavailable analytics are healthy.
