...
| Architecture | [Data model and ERD](../../../../architecture/02-data-model-and-erd.md), [lifecycle](../../../../architecture/06-lifecycle-and-recovery.md), [interfaces](../../../../architecture/09-interface-contracts.md) | Target schema, content projection, and recovery invariants |
